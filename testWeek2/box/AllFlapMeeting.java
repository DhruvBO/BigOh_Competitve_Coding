...
public class AllFlapMeeting extends Box{
	private int pastingCost = 30;
	public AllFlapMeeting(double length, double width, double height, HashMap<String, Integer> flute, char fluteType,
