...
public class TopOpeningSnapLock extends Box {
	private int pastingCost = 50;
	public TopOpeningSnapLock(double length, double width, double height, HashMap<String, Integer> flute,
