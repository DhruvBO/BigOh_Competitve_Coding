...
public class IndianPolitics {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nMP\n");
		Mp mp = new Mp("Ashok Nagar", "Greater Noida", "MP", 1000000000);
...
//		Mp
		...
		Minister minister = new Minister("Dilip Jangra", "Gautam Budh Nagar", "Minister", 1000000000);
...
//		Minister
		...
		Pm pm = new Pm("Sourabh Joshi", "India", "PM", 1000000000);
